...
void Huffman::deHuffer(string compressedFileName, string decompressedFileName){
    ...
    decompressedToFile(codeString,rootNode,decompressedFileName);
}
...
void Huffman::decompressedToFile(string codeString, Node *rootNode, string decompressedFileName){
    ofstream outputStream;
